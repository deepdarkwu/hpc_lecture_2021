...
void cacheBlocking(vector<float> &subA, vector<float> &subB, vector<float> &subC, int N, int size, int offset) {
...
//mpi_openmp_simd_cacheBlocking start
    cacheBlocking(subA,subB,subC,N,size,offset);
//mpi_openmp_simd_cacheBlocking end
